class UsersController < ApplicationController
  ...
  private
    ...
    def blah1(restaurant, spot_in_line)
      # next_spot_in_line = waiting_list.count # to check for the general wait time
      # user_reservation = restaurant.reservations.for_user(params[:id]).by_time_reserved.first
      ...
      blah2(spot_in_line, num_empty_tables, seated_and_waiting_list)
    end
    ...
    def blah2(spot_in_line, num_empty_tables, seated_and_waiting_list)
      ...
      if corresponding_reservation.is_seated?
        ...
        return blah2(corresponding_spot_in_line, num_empty_tables, seating_and_waiting_list) + 1.hour
      end
